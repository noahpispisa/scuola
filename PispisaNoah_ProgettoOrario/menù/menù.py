import menù.funzioniutili as f #contiene le funzioni per gli input e le parti di codice usate più spesso
...
sep = "-"*25 #un separatore

funzioni = ("elenco docenti classe","orario docente","ore disponibili","docenti a lezione","<funzione>","<funzione>","<funzione>","<funzione>","<funzione>","<funzione>","<funzione>")
def creavoci(tup):
    """
...
def scelta(min,max):
    ...
    parametri:
    min: la scelta minima possibili
